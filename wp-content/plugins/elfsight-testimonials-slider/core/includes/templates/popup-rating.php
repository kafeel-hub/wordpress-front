        ...
        <form class="elfsight-admin-popup-form" data-nonce="<?php echo wp_create_nonce($this->getOptionName('rating_send')); ?>">
            <div class="elfsight-admin-popup-body">
                ...
                <div class="elfsight-admin-popup-text elfsight-admin-popup-text-hide">
                    <?php _e('Please, share this rating on <a href="' . $this->productReviewUrl . '" target="_blank" rel="nofollow">wordpress.org</a>', $this->textDomain); ?>
                </div>
            </div>
            ...
            <div class="elfsight-admin-popup-thanks">
                ...
                <div class="elfsight-admin-popup-text elfsight-admin-popup-text-hide">
                    <?php _e('We are very grateful <br> for your awesome review on <a href="' . $this->productReviewUrl . '" target="_blank" rel="nofollow">wordpress.org</a>', $this->textDomain); ?>
                </div>
            </div>
            ...
            <div class="elfsight-admin-popup-footer">
                ...
                <a class="elfsight-admin-popup-footer-button elfsight-admin-popup-footer-button-ok elfsight-admin-popup-footer-button-hide" href="<?php echo $this->productReviewUrl; ?>" target="_blank" rel="nofollow"><?php _e('Rate us', $this->textDomain); ?></a>
            </div>
        </form>
    </div>
