...
?><article class="elfsight-admin-page-welcome elfsight-admin-page" data-elfsight-admin-page-id="welcome">
    ...
    <a class="elfsight-admin-page-welcome-button elfsight-admin-button-large elfsight-admin-button-blue elfsight-admin-button" href="#/add-widget/" data-elfsight-admin-page="add-widget"><?php _e('Create widget', $this->textDomain); ?></a>
</article>