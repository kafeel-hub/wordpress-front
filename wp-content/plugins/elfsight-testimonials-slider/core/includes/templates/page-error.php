...
?><article class="elfsight-admin-page-error elfsight-admin-page" data-elfsight-admin-page-id="error">
    ...
    <a class="elfsight-admin-page-error-button elfsight-admin-button-large elfsight-admin-button-blue elfsight-admin-button" href="#/widgets/" data-elfsight-admin-page="widgets"><?php _e('Back to Home', $this->textDomain); ?></a>
</article>