...
if (!class_exists('ElfsightTestimonialsSliderPlugin')) {
    class ElfsightTestimonialsSliderPlugin {
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightTestimonialsSliderPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            ...
            $this->widget = new ElfsightTestimonialsSliderWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightTestimonialsSliderVCElement($config, $this->widgetsApi);
